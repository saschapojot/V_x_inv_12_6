...
x0AStr=loadedJsonData["x0A"]
x0BStr=loadedJsonData["x0B"]
x1AStr=loadedJsonData["x1A"]
x1BStr=loadedJsonData["x1B"]
loopLastFile=loadedJsonData["loopLastFile"]

initValsStr=f"{LStr},"+f"{x0AStr},"+f"{x0BStr},"+f"{x1AStr},"+f"{x1BStr}"
